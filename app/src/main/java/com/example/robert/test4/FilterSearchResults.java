...
public class FilterSearchResults extends AppCompatActivity {
    ...
    private static final String TAG = "FilterSearchResults";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String str1 = extras.getString("search");
        String str2 = extras.getString("countSearch");
        this.search = str1;
        this.countSearch = str2;
        Cursor cursor;
        Cursor mcursor;
        ...
        cursor = sdb.rawQuery(search, null);
        mcursor = sdb.rawQuery(countSearch, null);
        ...
        //I was testing printing a message when there were no results from the query
        //
        ...
        if (count != 0) {
            ...
            //ListAdapter myAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, schoolArray); //Creates the nice listview from the array
            //listview.setAdapter(myAdapter);

            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    Intent intent = new Intent(FilterSearchResults.this, DisplayPage.class);
